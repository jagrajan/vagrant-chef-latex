...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.synced_folder "./chef/cookbooks/baseconfig/files/default", "/home/vagrant/chef_files"
  config.vm.synced_folder "./chef/cookbooks/baseconfig/recipes", "/home/vagrant/chef_recipe"
